                        ...
                        <ScrollView>
                            <TouchableOpacity activeOpacity={0.7}>
                                <View>
                                    <ImageBackground
                                        ...
                                        imageStyle={
                                            MyProfileStyles.borderRadius
                                        }
                                        style={MyProfileStyles.profileIcon}>
                                        <View
                                            style={MyProfileStyles.levelStyle}>
                                            <Text
                                                style={
                                                    MyProfileStyles.levelText
                                                }>
                                                Level {level}
                                            </Text>
                                        </View>
                                        <View
                                            style={
                                                MyProfileStyles.overlappingStyle
                                            }>
                                            <View>
                                                <Text
                                                    style={
                                                        MyProfileStyles.heading
                                                    }>
                                                    {full_name}
                                                </Text>
                                                <Text
                                                    style={
                                                        MyProfileStyles.subHeading
                                                    }>
                                                    {motto_description}
                                                </Text>
                                            </View>
                            ...
                            <View style={MyProfileStyles.headerMainView}>
                                <TouchableOpacity
                                    ...
                                    <Text style={MyProfileStyles.section2}>
                                        {followerCount}
                                    </Text>
                                    <Text style={MyProfileStyles.section1}>
                                        {'Followers'}
                                    </Text>
                                </TouchableOpacity>
                                <TouchableOpacity
                            ...
                            <FlatList
                                ...
                                contentContainerStyle={
                                    MyProfileStyles.sectionMainView2
                                }
