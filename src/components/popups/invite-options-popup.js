...
const InviteOptionPopup = ({
    ...
    <AnimatedModal visible>
        <TouchableOpacity
            style={InvitePopupStyles.popup}
            activeOpacity={1}
            onPress={onClose}>
            <View style={InvitePopupStyles.container}>
                <View style={InvitePopupStyles.wrapper}>
                    <Text style={InvitePopupStyles.headerText}>
                        {translate('settings.Share to')}
                    </Text>
                    <View style={InvitePopupStyles.row}>
                        {onStrava && (
                            <TouchableOpacity
                                style={InvitePopupStyles.social}
                                activeOpacity={0.7}
                                onPress={onStrava}>
                                <Image
                                    resizeMode="contain"
                                    style={InvitePopupStyles.socialIcon}
                                    source={Constants.Images.strava}
                                />
                                <Text style={InvitePopupStyles.socialText}>
                                    {translate('Strava')}
                                </Text>
                            </TouchableOpacity>
                        )}
